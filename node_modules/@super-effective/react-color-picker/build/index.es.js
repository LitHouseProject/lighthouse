...
var HueSlider = function (_a) {
    ...
    var _f = useState(false), isInteracting = _f[0], setIsInteracting = _f[1];
    ...
    return (jsx("div", __assign({ className: classNames(styles$2.hue_slider, className, (_b = {}, _b[styles$2.vertical] = layout === HueSlider.LAYOUTS.VERTICAL, _b)), ref: sliderDivRef, title: "Hue" }, interactionCallbacks, { children: jsx("div", { className: classNames(styles$2.hue_slider_picker, pickerClassName), style: sliderStyle }, void 0) }), void 0));
};
HueSlider.LAYOUTS = {
...
var SaturationValueSelector = function (_a) {
    ...
    var _d = useState(false), isInteracting = _d[0], setIsInteracting = _d[1];
    ...
    return (jsx("div", __assign({ className: classNames(styles$1.saturation_value_selector, className), style: {
            backgroundColor: hueColor,
        }, ref: selectorDivRef, title: "Saturation and Value" }, interactionCallbacks, { children: jsx("div", { className: classNames(styles$1.saturation_value_picker, pickerClassName), style: {
                left: saturation * 100 + "%",
                top: (1 - value) * 100 + "%",
                backgroundColor: hex,
            } }, void 0) }), void 0));
...
var ReactColorPicker = function (_a) {
    ...
    var _j = useState(sanitizedColor), hex = _j[0], setHex = _j[1];
    var _k = useState(hexToHsv(sanitizedColor)), hsv = _k[0], setHsv = _k[1];
    var _l = useState(false), isInteracting = _l[0], setIsInteracting = _l[1];
    // Used when editing the hex through the input
    var _m = useState(hex), tempHex = _m[0], setTempHex = _m[1];
    ...
    return (jsxs("div", __assign({ className: "" + styles.react_color_picker + (className ? " " + className : '') }, rest, { children: [jsx("div", __assign({ className: styles.saturation_value_selector }, { children: jsx(SaturationValueSelector, { className: saturationValueClassName, pickerClassName: saturationValuePickerClassName, hue: hue, saturation: saturation, value: value, onChange: function (updatedSaturationValue) { return setColorFromHsv(__assign(__assign({}, hsvRef.current), updatedSaturationValue)); }, onInteractionStart: onControlInteractionStart, onInteractionEnd: onControlInteractionEnd }, void 0) }), void 0),
            jsx(HueSlider, { className: hueClassName, pickerClassName: huePickerClassName, hue: hue, onChange: function (updatedHue) { return setColorFromHsv(__assign(__assign({}, hsvRef.current), { hue: updatedHue })); }, onInteractionStart: onControlInteractionStart, onInteractionEnd: onControlInteractionEnd }, void 0),
            (showHex || showSwatch) && (jsxs("div", __assign({ className: styles.details }, { children: [showSwatch && (jsx("div", { className: styles.swatch, style: {
                            backgroundColor: hex,
                        }, title: "Swatch" }, void 0)),
                    showHex && (jsxs("label", { children: [jsx("span", { children: "Hex:" }, void 0),
                            jsx("input", { className: styles.hex_value, value: tempHex, onChange: function (evt) { return setTempHex(evt.target.value); }, onBlur: function (evt) { return onHexChange(evt.target.value); }, onKeyDown: function (evt) {
